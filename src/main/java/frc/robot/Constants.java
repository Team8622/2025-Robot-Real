...
public final class Constants {
    ...
    public static final class ElevatorConstants{
        ...
        public static double maxPos = L3 + 5;
        public static double posTolerance = .5;

        public static double maxVelocity = 30; // inches per second
        public static double maxAcceleration = 60;
        public static double max_output = .4; //percent of motor power
        ...
        public static double kI = 0.000; // corrects any accumulated error in kP
        public static double kD = 0.022; //smooths out oscillations
        public static double kS = .00001; // static friction ff (feedforward)
        public static double kG = 0; // gravity ff
        public static double kV = 0.0001; // velocity ff - anticipates expected velocity
